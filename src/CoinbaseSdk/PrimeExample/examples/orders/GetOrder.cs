...
var rootCommand = new RootCommand("Get details of a specific order")
{
    portfolioIdOption,
    orderIdOption,
};
...
rootCommand.SetHandler((context) =>
{
    ...
    try
    {
        ...
        var request = new GetOrderRequest(portfolioId, orderId);
    ...
    {
        PrettyPrinter.PrintError("Error getting order", ex);
        Environment.ExitCode = 1;
    }
});
