...
var nettingIdOption = new Option<string?>(
    name: "--nettingId",
    description: "The Netting ID");

var rootCommand = new RootCommand("List Allocations By Client Netting Id")
{
    portfolioIdOption,
    nettingIdOption,
};
...
rootCommand.SetHandler((context) =>
{
    ...
    try
    {
        ...
        Console.WriteLine($"Using NettingId: {nettingId}");
    ...
    {
        PrettyPrinter.PrintError("Error calling ListAllocationsByClientNettingId", ex);
        Environment.ExitCode = 1;
    }
});
