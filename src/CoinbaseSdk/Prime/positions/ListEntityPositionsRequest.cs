...
namespace CoinbaseSdk.Prime.Positions
{
  ...
  public class ListEntityPositionsRequest(string entityId) : PaginatedRequest
  {
    ...
    public class ListEntityPositionsRequestBuilder
    {
      ...
      public ListEntityPositionsRequestBuilder WithEntityId(string entityId)
      {
        _entityId = entityId;
        return this;
      }
      ...
      public ListEntityPositionsRequestBuilder WithSortDirection(SortDirection sortDirection)
      {
