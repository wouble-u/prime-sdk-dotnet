...
public class OpenApiGenerator
{
  ...
  public OpenApiGenerator(ILogger<OpenApiGenerator> logger, string projectRoot, string specUrl, string outputDir)
  {
    _logger = logger;
  ...
  public async Task GenerateModelsAsync()
  {
    ...
    var ignoreFile = Path.Combine(GeneratorPaths.ConfigDirectory(_projectRoot), ".openapi-generator-ignore");
    ...
    var templatesDir = GeneratorPaths.TemplatesDirectory(_projectRoot);
